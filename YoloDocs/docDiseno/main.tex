...
\end{figure}
	...
	\begin{figure}
  \centering
  \subfigure[Disparo de tonalli.]{\includegraphics[width=0.45 \textwidth]{Imagenes/PantallaInteraccionEnemigo}}
   \subfigure[Colisión disparo de tonalli con enemigo común.]{\includegraphics[width=0.45 \textwidth]{Imagenes/PantallaInteraccionEnemigo02}}
   \subfigure[Destrucción del enemigo y el disparo de tonalli.]{\includegraphics[width=0.45 \textwidth]{Imagenes/PantallaInteraccionEnemigo03}}
...
\end{figure} 
	...
	\begin{figure}
  \centering
  \subfigure[Acción del botón de moverse derecha.]{\includegraphics[width=0.45 \textwidth]{Imagenes/ControlCorrerDerGUI}}
   \subfigure[Acción del botón de moverse izquierda.]{\includegraphics[width=0.45 \textwidth]{Imagenes/ControlCorrerIzq}}
   \subfigure[Acción del botón de disparar.]{\includegraphics[width=0.45 \textwidth]{Imagenes/Controldispara}}
   \subfigure[Acción del botón de saltar.]{\includegraphics[width=0.45 \textwidth]{Imagenes/ControlSalta}}
