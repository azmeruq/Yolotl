...
%\input{02Antecedentes/tt1R/tete}
...
\begin{figure}[h]
          \centering
           \subfigure[Modelo de \textit{Malinalli} generado en \textit{Blender}.] {\includegraphics[width=0.3 \textwidth]{02Antecedentes/Imagenes/Malinalli_proceso.png}}
   
         \subfigure[Modelo de \textit{Xólotl} generado en \textit{Blender}.]{\includegraphics[width=0.3 \textwidth]{02Antecedentes/Imagenes/xolo.jpg}}
     
        \subfigure[Modelo de un templo generado en \textit{Blender}.] {\includegraphics[width=0.3 \textwidth]{02Antecedentes/Imagenes/templo.png}}
        
        \subfigure[Modelo de una mujer comerciante generado en \textit{Blender}.] {\includegraphics[width=0.3 \textwidth]{02Antecedentes/Imagenes/Mujer04_game.png}}
