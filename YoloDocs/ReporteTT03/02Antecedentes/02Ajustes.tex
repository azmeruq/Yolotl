...
creación de niveles como el uso de:
    \begin{itemize}
        ...
        pues el controlador de gráficos de \textit{Unity} realiza una sola llamada
        ...
        gráficos de \textit{Unity} haría una llamada por cada \textit{sprite} aumentando el tiempo de renderizado.  
            \begin{figure}[h]
                \centering
    ...
    \textit{Unity}, se propone utilizarla en lugar de la versión 5.6.2f1. Antes
...
\input{02Antecedentes/ajustesR/maquinasEdos}
