...
\begin{figure}
  \centering
   ...
   \subfigure[Dos alumnos de la Escuela Superior de Computo probando el juego.] {\includegraphics[width=0.4 \textwidth]
   {04ResultadosObetnidos/imagenes/usuarios01}}
        
        \subfigure[Grupo de alumnos de la Escuela Superior de Computo probando el 
