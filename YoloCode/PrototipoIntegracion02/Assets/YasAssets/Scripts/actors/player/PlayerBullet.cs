...
public class PlayerBullet : MonoBehaviour {
	...
	void OnTriggerEnter2D(Collider2D other){
		if ((other.gameObject.CompareTag ("Enemy")||other.gameObject.CompareTag ("Obstacle"))||(other.gameObject.CompareTag ("EnemyShell"))) {
			...
			Destroy (gameObject);
		} else if ((!other.gameObject.CompareTag ("Player")&&!other.gameObject.CompareTag ("Camera"))&&(!other.gameObject.CompareTag ("Checkpoint"))&&!other.gameObject.CompareTag ("Playerfeet")) {
			Destroy (gameObject);
		}
